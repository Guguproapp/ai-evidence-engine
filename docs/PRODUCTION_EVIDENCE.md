...
| Final public demo video | PASS — judge-accessible | Narrated replacement `pqRNOvyE3_c`: 2:43, 1920×1080, 48 kHz mono AAC English narration, real Production operation, and English captions. YouTube reported no check issue and signed-out oEmbed returned HTTP 200 on 2026-08-15. Silent `HDG1qYo5hUg` and old `Fwu7yGUTVwo` are superseded |
