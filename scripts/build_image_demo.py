...
def main():
    ...
    for version in (1, 2, 3):
        ...
        event = registry.register_file(
            ...
            asset_type="digital_image",
            media_type="image/png",
            device_id="gugupro-demo-workstation",
            software="gugupro deterministic image demo",
            software_version="0.2.0",
            model_provider="gugupro",
            model_id="deterministic-image-demo",
            source_assets=[] if version == 1 else [parent_version],
            authorization_id=None,
            c2pa_manifest_id=read_report.get("active_manifest"),
            trust_status="development",
            change_metrics={} if version == 1 else {"spatial_change_ratio": masks[version]["changed_ratio"], "bounding_box": masks[version]["bounding_box"]},
            public_disclosure_level="public_minimum",
        )
        events.append({
            **event,
            "version_id": version_id,
